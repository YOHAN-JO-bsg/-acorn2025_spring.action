...
public class MemberDaoImpl implements MemberDao{
	...
	// 생성자를 이용해서 의존 객체를 주입 받는것이 더 일반적이다.
	// @Autowired // 생성자가 오직 1개인 경우에는 생략 가능하다. (lombok 의 기능을 이용하면 생략 가능하다)
	 ...
	 *  select 되는 row 가 여러개일 가능성이 있으면 session.selectAll() 메소드를 사용해서 select 한다.
	 */
	@Override
